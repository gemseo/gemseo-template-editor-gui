...
class QtTemplateEditor(QMainWindow):
    ...
    def __get_open_filename(self, name: str) -> tuple[str, bool]:
    ...
    def __get_save_filename(self, name: str) -> tuple[str, bool]:
    ...
    def add_action(
        self, name: str, status_tip: Any, shortcut: Any, connect: Any
    ) -> QAction:
